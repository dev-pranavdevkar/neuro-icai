                        ...
                        <div class="card-body">
                            ...
                            <div class="">
                                ...
                                <p>Convocation Ceremony held on 27th May 2023 at Pune <b>Click below link to view Photos of
                                        Convocation Ceremony. <br />Link :</b><a href="#"> Click here To View
                                        Photos</a></p>
                            </div>
                            <div>
                                    ...
                                    <ul class="">
                                        ...
                                        <li>
                                            <div class="row">
                                                ...
                                                <div class="col-11">
                                                    <a href="#">Schedule and Registration form of the Mock Test Papers
                                                        (Series–I) to be held from 05th Sep to 14th Sep, 2023 for the
                                                        students of Intermediate and Final level appearing in the Nov, 2023
                                        ...
                                        <li>
                                            <div class="row">
                                                ...
                                                <div class="col-11">
                                                    <a href="#">Schedule of the Coaching classes batch for Foundation
                                                        Revision Batch for Nov -2023
                                        ...
                                        <li>
                                            <div class="row">
                                                ...
                                                <div class="col-11">
                                                    <a href="#">Schedule of the Coaching classes batch for
                                                        Intermediate for May -2024
                                                    </a>
                                        </li>
                                        <li>
                                            <div class="row">
