                ...
                <div class="footer__widget footer__widget--address">
                    ...
                    <div class="footer__widget footer__widget--social">
                        <ul class="d-flex justify-content-between">
                            <li><a href="https://www.facebook.com/punewirc/"><i class="fa fa-facebook"></i> </a></li>
                            <li><a href="https://twitter.com/PuneICAI"><i class="fa fa-twitter"></i> </a></li>
                            <li><a href="https://www.linkedin.com/in/puneicai/"><i class="fa fa-linkedin"></i> </a></li>
                            <li><a href="https://www.youtube.com/PuneICAIOfficial"><i class="fa fa-youtube"></i> </a>
                            </li>
                ...
                <div class="footer__widget footer__widget--address">
                    ...
                    <div class="footer__widget footer__widget--social">
                        <ul>
                            ...
                            <li><a href="mailto: pune@icai.org"><i class="fa fa-envelope"></i> pune@icai.org</a></li>
                ...
                <div class="col-lg-6 col-md-6 ">
                    <div class="footer__copyright__text">
                        <p>Copyright &copy;
                            ...
                            </script> All rights reserved |<a class="text-white" href="{{ url('/') }}"> The Institute
